        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-white/40 mb-12 max-w-lg leading-relaxed font-light">
              ...
              Built for <span className="text-white/80">precision</span>, scaled
              for <span className="text-white/80">growth</span>, secured for{" "}
              <span className="text-white/80">eternity</span>.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-8">
              ...
              <Link href="https://inventory-management-indol-two.vercel.app/login">
                <Button
                  variant="outline"
                  className="border-white/10 text-white/80 hover:bg-white/5 px-12 py-8 rounded-full text-[11px] uppercase tracking-[0.2em] transition-all duration-500 h-auto"
                >
                  Launch Sandbox
                </Button>
              </Link>
            ...
            <div className="mt-16 flex items-center space-x-10">
              <div className="flex -space-x-4">
                {[1, 2, 3, 4].map((i) => (
                  <div
                    key={i}
                    className="h-12 w-12 rounded-full border-[3px] border-charcoal bg-white/5 overflow-hidden backdrop-blur-sm"
                  />
                ))}
              </div>
              <p className="text-[10px] text-white/30 font-bold uppercase tracking-[0.3em] leading-tight">
                Trusted by <br />
                <span className="text-gold text-lg">50+</span> Global Boutiques
              </p>
            </div>
          </motion.div>
